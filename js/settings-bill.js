...
function color(){
   if(referenceSettings.getTotals() <= referenceSettings.getWarningLevel()){
      totalSettings.classList.remove('warning');
   }
   if(referenceSettings.getTotals() >= referenceSettings.getWarningLevel()  & referenceSettings.getTotals() <referenceSettings.getCriticalLevel()){
      totalSettings.classList.add("warning");
   }
   else if (referenceSettings.getTotals() >= referenceSettings.getCriticalLevel()){
